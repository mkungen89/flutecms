...
class ColorController extends BaseController
{
    ...
    public function saveTheme(FluteRequest $fluteRequest)
    {
        ...
        $settingsRules = [
            ...
            'space_xs' => 'sometimes|string|max-str-len:20',
            'space_sm' => 'sometimes|string|max-str-len:20',
            'space_md' => 'sometimes|string|max-str-len:20',
            'space_lg' => 'sometimes|string|max-str-len:20',
            'space_xl' => 'sometimes|string|max-str-len:20',
            'transition' => 'sometimes|string|max-str-len:20',
            'blur_amount' => 'sometimes|string|max-str-len:20',
            'card_opacity' => 'sometimes|string|max-str-len:20',
            'glow_intensity' => 'sometimes|string|max-str-len:20',
            'max_content_width' => 'sometimes|string|max-str-len:20',
            'widget_gap' => 'sometimes|string|max-str-len:40',
