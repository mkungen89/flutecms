...
$router->get('sidebar/notifications', [NotificationsSidebar::class, 'sidebarNotifications'])->middleware([
    'auth',
    'htmx',
    'site_mode:notifications',
]);
$router
    ->get('sidebar/notifications/all', [NotificationsSidebar::class, 'all'])
    ->middleware(['auth', 'htmx', 'site_mode:notifications'])
    ->name('notifications.all');
$router
    ->get('sidebar/notifications/all/splitted', [NotificationsSidebar::class, 'allSplitted'])
    ->middleware(['auth', 'htmx', 'site_mode:notifications'])
    ->name('notifications.all.splitted');
$router
    ->get('sidebar/notifications/unread', [NotificationsSidebar::class, 'unread'])
    ->middleware(['auth', 'htmx', 'site_mode:notifications'])
    ->name('notifications.unread');
$router
    ->get('sidebar/notifications/unread/splitted', [NotificationsSidebar::class, 'unreadSplitted'])
    ->middleware(['auth', 'htmx', 'site_mode:notifications'])
    ->name('notifications.unread.splitted');
