...
return [
    'labels' => [
        ...
        'notifications_sound_enabled' => 'Notification Sound',
        ...
        'social_supplement' => 'Profile Supplement on Social Login',
        ...
        'recaptcha_v3_score_threshold' => 'reCAPTCHA v3 Score Threshold',
    ...
    'placeholders' => [
        ...
        'recaptcha_v3_site_key' => 'Enter reCAPTCHA v3 site key',
        'recaptcha_v3_secret_key' => 'Enter reCAPTCHA v3 secret key',
    ...
    'popovers' => [
        ...
        'social_supplement' => 'When enabled, after social login the user will be prompted to fill in login, email, and password.',
        ...
        'recaptcha_v3_site_key' => 'Get your reCAPTCHA v3 site key from <a target="_blank" href="https://www.google.com/recaptcha/admin">Google reCAPTCHA</a>.',
        'recaptcha_v3_secret_key' => 'Get your reCAPTCHA v3 secret key from <a target="_blank" href="https://www.google.com/recaptcha/admin">Google reCAPTCHA</a>.',
        'recaptcha_v3_score_threshold' => 'Minimum score required to pass validation (0.0–1.0).',
