...
return [
    ...
    'confirms' => [
        ...
        'regenerate_key' => 'Старый API ключ перестанет работать. Перегенерировать ключ?',
    ],
    'messages' => [
        'save_success' => 'API ключ успешно сохранен.',
        'regenerate_success' => 'API ключ успешно перегенерирован.',
    ...
    'empty' => [
        ...
        'sub' => 'Создайте API ключ для интеграции с внешними сервисами',
    ],

    'info_alert' => [
        'title' => 'Для работы API необходим модуль',
        'description' => 'API ключи позволяют аутентифицировать запросы, но для полноценной работы API требуется установка модуля API из маркетплейса.',
        'install_module' => 'Установить модуль',
        'documentation' => 'Документация',
    ],

    'created_alert' => [
        'title' => 'Скопируйте API ключ сейчас',
        'description' => 'Ключ ":name" будет показан только один раз. После закрытия страницы его можно будет только перегенерировать.',
    ],
];
