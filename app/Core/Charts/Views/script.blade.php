                ...
                const start = () => {
                    try {
                        ...
                        const themedOptions = {
                            ...
                            stroke: isAreaOrLine
                                ? { curve: 'smooth', width: 2, lineCap: 'round', ...(options.stroke || {}) }
                                : (options.stroke || {}),
                            fill: isAreaOrLine ? {
                                ...( options.fill || {} ),
                                type: 'gradient',
                            ...
                            legend: {
                                ...
                                fontSize: '12px',
                                fontWeight: 500,
                                markers: { size: 4, shape: 'square', radius: 2 },
                            ...
                            xaxis: {
                                ...
                                labels: {
                                    style: { colors: textMuted, fontSize: '11px', fontWeight: 400 },
                            ...
                            plotOptions: {
                                ...(options.plotOptions || {}),
                                bar: { borderRadius: 4, columnWidth: '55%', ...(options.plotOptions?.bar || {}) },
                                pie: {
                                    donut: {
                                        size: '75%',
                                        labels: {
                                            show: true,
                                            name: { show: true, fontSize: '12px', fontWeight: 500, color: textMuted },
                                            value: { show: true, fontSize: '22px', fontWeight: 600, color: textColor },
                                            total: { show: true, fontSize: '12px', fontWeight: 500, color: textMuted },
                                        },
                                    },
                                ...
                                radialBar: {
                                    ...
                                    dataLabels: {
                                        name: { fontSize: '12px', fontWeight: 500, color: textMuted },
                                        value: { fontSize: '22px', fontWeight: 600, color: textColor },
                                    },
